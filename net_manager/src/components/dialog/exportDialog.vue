    ...
    <div class="centerLayer">
      <div class="popup">
        ...
        <div class="popupWrap clf">
          <h4>导出哪些数据</h4>
          <div class="data">
            <input type="radio" name="seleData" value="1" id="present" v-model="select">
          ...
          <div class="fields_box">
            <div class="fields">考试名称<i class="iconfont">&#xe663;</i></div>
            <div class="fields">考试名称<i class="iconfont">&#xe663;</i></div>
            <div class="fields">考试名称<i class="iconfont">&#xe663;</i></div>
            <div class="fields">考试名称<i class="iconfont">&#xe663;</i></div>
            <div class="fields">考试名称<i class="iconfont">&#xe663;</i></div>
